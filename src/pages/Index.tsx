  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-barbershop-dark via-barbershop-dark-light to-black">
      ...
      <header className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-barbershop-gold/20 to-transparent"></div>
        <div className="container mx-auto px-4 py-8 relative z-10">
          <nav className="flex justify-between items-center mb-12">
            <div className="flex items-center space-x-2">
              <Scissors className="h-8 w-8 text-barbershop-gold" />
              <h1 className="text-2xl font-bold text-white">BarberShop Premium</h1>
            </div>
            <div className="space-x-4">
              <Link to="/agendamento">
                <Button className="bg-barbershop-gold hover:bg-barbershop-gold/80 text-barbershop-dark font-semibold">
                  <Calendar className="mr-2 h-4 w-4" />
                  Agendar
                </Button>
              </Link>
              <Link to="/admin">
                <Button variant="outline" className="border-barbershop-gold text-barbershop-gold hover:bg-barbershop-gold hover:text-barbershop-dark">
                  Admin
                </Button>
              </Link>
            </div>
          ...
          <div className="text-center py-20 animate-fade-in">
            <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 text-shadow">
              Estilo que
              <span className="text-barbershop-gold"> Marca</span>
            </h2>
            ...
            <Link to="/agendamento">
              <Button size="lg" className="bg-barbershop-gold hover:bg-barbershop-gold/80 text-barbershop-dark font-bold text-lg px-8 py-4 hover-lift">
      ...
      <section className="py-20 bg-black/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">Qualidade premium em cada detalhe</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className="bg-barbershop-dark-light border-barbershop-gold/20 hover-lift animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">Profissionais experientes e especializados</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {barbers.map((barber, index) => (
              <Card key={index} className="bg-barbershop-dark-light border-barbershop-gold/20 hover-lift animate-fade-in" style={{ animationDelay: `${index * 0.2}s` }}>
                <CardHeader className="text-center">
      ...
      <footer className="py-8 bg-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">© 2024 BarberShop Premium. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
